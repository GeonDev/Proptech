...
INSERT INTO `user` (`id`, `user_name`, `company_id`, `password`, `name`, `email`, `profile_img`, `user_role`, `user_state`, `retired_date`, `reg_date`, `modi_date`, `modi_password_date`, `phone_number`) VALUES
	(1, 'Admin', NULL, '1111', '관리자', NULL, 'img/proflie_img.jpg', 'ADMIN', 'AUTH', NULL, '2021-06-03', NULL, NULL, '02-3554-0901'),
	(2, 'Manager', NULL, '2222', '운영자', NULL, 'img/proflie_img.jpg', 'MANAGER', 'AUTH', NULL, '2021-06-03', NULL, NULL, '02-3456-2034'),
	(3, 'Partner', 1, '3333', '파트너사', NULL, 'img/proflie_img.jpg', 'PARTNER', 'AUTH', NULL, '2021-06-03', NULL, NULL, '02-3456-1245'),
	(4, 'Staff01', NULL, '0101', '스탭1', NULL, 'img/proflie_img.jpg', 'STAFF', 'AUTH', NULL, '2021-06-03', NULL, NULL, '010-3434-3941'),
	(5, 'Staff02', NULL, '0202', '스탭2', NULL, 'img/proflie_img.jpg', 'USER', 'AUTH', NULL, '2021-06-03', NULL, NULL, NULL),
	(6, 'User01', NULL, '0101', '김OO', NULL, 'img/proflie_img.jpg', 'USER', 'UN_AUTH', NULL, '2021-06-03', NULL, NULL, NULL),
	(7, 'User02', NULL, '0202', '이OO', NULL, 'img/proflie_img.jpg', 'USER', 'UN_AUTH', NULL, '2021-06-03', NULL, NULL, NULL),
	(8, 'User03', NULL, '0303', '박OO', NULL, 'img/proflie_img.jpg', 'USER', 'UN_AUTH', NULL, '2021-06-03', NULL, NULL, NULL);
